(function(global) {
  ...
  if (fabric.BolloonTextbox) {
    fabric.warn('fabric.BolloonTextbox is already defined');
    return;
  }
  if (!fabric.Object) {
    fabric.warn('fabric.BolloonTextbox requires fabric.Object');
    return;
  }
  ...
  /**
   * BolloonTextbox class
   * @class fabric.BolloonTextbox
  ...
  fabric.BolloonTextbox = fabric.util.createClass(fabric.Text, /** @lends fabric.Textbox.prototype */
    {
      /**
       * Type of an object
       * @type String
      ...
      //  this.callSuper('initialize', options);
        ...
        //  _this.textObject = new fabric.IText(text, options);
   ...
   */
  fabric.BolloonTextbox.fromObject = function(object) {
    var instance = new fabric.BolloonTextbox(object.originalText, clone(object), function() {
