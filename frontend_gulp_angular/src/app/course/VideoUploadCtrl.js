//'use strict';
//
////var app = angular.module('icetraiFront', [ 'ngFileUpload' ]);
////var version = '4.2.0';
////
////app.controller('VideoUploadCtrl', [ '$scope', '$http', '$timeout', '$compile', 'Upload', function($scope, $http, $timeout, $compile, Upload) {
